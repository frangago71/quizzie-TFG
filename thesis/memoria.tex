...
\begin{document}
    ...
    % Anexos
    \input{sections/99_Prototipos_de_interfaz_de_usuario}
    \input{sections/99_Manual_de_usuario}
    \input{sections/99_Manual_tecnico}
    \input{sections/99_Registro_de_pruebas_y_cobertura}
    \input{sections/99_Dedicacion_temporal.tex}
