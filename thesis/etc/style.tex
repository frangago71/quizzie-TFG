...
\definecolor{neutralGrey}{RGB}{191, 191, 191}
...
\newcommand{\traceCross}{\textcolor{black}{\scalebox{1.6}{\textbf{\texttimes}}}}
\newcommand{\traceCrossGray}{\textcolor{gray!90!black}{\scalebox{1.6}{\textbf{\texttimes}}}}
...
\renewcommand*\l@table{\@dottedtocline{1}{1.5em}{2.6em}}

\ifcsname l@evidence\endcsname
  \renewcommand*\l@evidence{\@dottedtocline{1}{1.5em}{2.6em}}
\fi

\ifcsname l@lstlisting\endcsname
  \renewcommand*\l@lstlisting{\@dottedtocline{1}{1.5em}{2.6em}}
\fi
\makeatother
...
\makeatletter
\newcommand{\bigcline}[1]{%
  \noalign{\vspace{1.5pt}\global\dimen@\arrayrulewidth\global\arrayrulewidth=1pt}%
  \cline{#1}%
  \noalign{\global\arrayrulewidth\dimen@\vspace{1.5pt}}%
}
\makeatother

% Estilos de columna para tablas
