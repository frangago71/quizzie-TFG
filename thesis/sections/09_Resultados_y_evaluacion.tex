...
\end{lstlisting}
\caption{Resumen de ejecución y cobertura en backend (\textbf{pytest-cov}).}
...
-----------------------|---------|----------|---------|---------|
\end{lstlisting}
\caption{Resumen de pruebas y cobertura de componentes (\textbf{Vitest}).}
...
-------------------|---------|---------|----------|---------|---------|
\end{lstlisting}
\caption{Resumen de pruebas y cobertura \textit{End-to-End} (\textbf{Playwright} + \textbf{Monocart}).}
...
=======================================================================
\end{lstlisting}
\caption{Evaluación de cumplimiento de umbrales de latencia percentil 90 ($P_{90}$) y tasa de error.}
\label{ev:resumen_umbrales}
\end{evidence}

\subsection{Evaluación global frente a umbrales de calidad}\label{sub:evaluacion_umbrales_calidad}
