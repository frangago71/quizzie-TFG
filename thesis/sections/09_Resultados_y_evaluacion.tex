...
\end{tabular}
\end{center}
\caption{Diagrama de Gantt de seguimiento: cronograma planificado \textit{vs.} real.}
...
\section{Desviaciones y gestión de cambios realizados}\label{sec:desviaciones_y_gestion_cambios}
