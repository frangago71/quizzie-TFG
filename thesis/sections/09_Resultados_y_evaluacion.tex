...
Resultados obtenidos en las pruebas unitarias(backend), de integración(backend), componentes frontend,  E2E, carga y rendimiento, y su comparación con los objetivos establecidos
