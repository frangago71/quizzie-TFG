...
\begin{itemize}
    ...
    \item \textbf{Python} (versión 3.12) \cite{python_official}.
...
Instalar el gestor de paquetes \texttt{uv} \cite{uv_official}, sincronizar el entorno virtual con las dependencias del proyecto y poblar la base de datos con los registros iniciales:

\begin{lstlisting}
(*@\cliPrompt@*) (*@\bashYellow{cd}@*) backend
(*@\cliPrompt@*) (*@\bashYellow{pip}@*) install uv         (*@\covGreen{\# Instalar uv si no está disponible en el sistema}@*)
(*@\cliPrompt@*) (*@\bashYellow{uv}@*) sync               (*@\covGreen{\# Crear entorno virtual y sincronizar dependencias}@*)
