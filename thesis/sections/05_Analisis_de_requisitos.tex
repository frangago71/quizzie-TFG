...
Usabilidad & \textbf{RNF-06}\label{rnf:06} & \textbf{Adaptabilidad:} Interfaz de usuario adaptativa (\textit{Responsive Design}) optimizada para una navegación fluida tanto en dispositivos móviles como en ordenadores. \\ 
