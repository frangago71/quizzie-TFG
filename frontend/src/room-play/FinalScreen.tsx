      ...
      {showExitModal && (
        <div className="modal-overlay">
          <div className="modal-content warning-modal">
            ...
            <p>
              Tu nota aún no ha sido verificada por el profesor. Si sales ahora,
              es posible que no se guarde correctamente.
            </p>
          ...
          onScan={async (decodedText) => {
            ...
            try {
              ...
              if (error.response?.status === 409) {
                toast.warning(
                  `El resultado de ${qrData?.nickname || "este alumno"} ya ha sido verificado.`,
                );
              } else {
