...
export interface Room {
  id: number;
  status: "live" | "waiting" | "verifying" | "finished";
}
    ...
    <div className="modal-overlay" onClick={onCancel}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <p>
            Puedes elegir si deseas borrar solo el cuestionario o también las
            salas (historial) asociadas a él.
          </p>
        </div>
        ...
        >
          ...
          <button
            ...
            title={
              hasActiveRooms
                ? "No se puede borrar el cuestionario porque tiene salas activas"
                : ""
            }
          >
